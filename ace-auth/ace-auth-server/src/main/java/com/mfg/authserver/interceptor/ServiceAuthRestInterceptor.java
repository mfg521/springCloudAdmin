package com.mfg.authserver.interceptor;

import com.mfg.auth.common.exception.auth.ClientForbiddenException;
import com.mfg.auth.common.util.jwt.IJWTInfo;
import com.mfg.authserver.configuration.ClientConfiguration;
import com.mfg.authserver.service.AuthClientService;
import com.mfg.authserver.util.client.ClientTokenUtil;
